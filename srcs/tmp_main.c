...
// 	world.objs[6].material.refractive_index = 1.52;
// 	shape_set_matrix(world.objs + 5, matrix_mult(matrix_translation(1, -4.2, -1.5), matrix_scaling(0.75, 0.75, 0.75)));
// 	world.objs[6].material.color = color(0, 0, 0);
// 	world.objs[6].material.refractive_index = 1.5;
// 	world.objs[6].material.transparency = 1;
// 	shape_set_matrix(world.objs + 6, matrix_mult(matrix_translation(1, -4, 1), matrix_scaling(0.5, 0.5, 0.5)));
