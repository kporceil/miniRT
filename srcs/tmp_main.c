...
/*   Updated: 2025/10/15 17:24:03 by lcesbron         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	world.objs[1].material.color = color(1.0, 0.0, 0.0);
	world.objs[1].material.diffuse = 0.7;
	world.objs[1].material.specular = 0.3;
	world.objs[1].material.reflective = 0.4;
	...
	world.objs[3].material.reflective = 0.2;
