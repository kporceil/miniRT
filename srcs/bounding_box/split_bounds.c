...
static void	split_x(t_bounding_box b, t_bounding_box *left,
					t_bounding_box *right, double dx)
{
	t_tuple	min_helper;
	t_tuple	max_helper;
...
static void	split_y(t_bounding_box b, t_bounding_box *left,
					t_bounding_box *right, double dy)
{
	t_tuple	min_helper;
	t_tuple	max_helper;
...
static void	split_z(t_bounding_box b, t_bounding_box *left,
					t_bounding_box *right, double dz)
{
	t_tuple	min_helper;
	t_tuple	max_helper;
...
void	bb_split_bounds(t_bounding_box b, t_bounding_box *left,
