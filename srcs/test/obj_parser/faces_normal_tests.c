...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   faces_normal_tests.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: lcesbron <lcesbron@student.42lyon.fr>      +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/11/18 12:56:18 by lcesbron          #+#    #+#             */
/*   Updated: 2025/11/28 21:36:48 by lcesbron         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
static void	face_normal_obj_parser_1_test(__unused void **state)
{
	t_obj_parsing	parsed = obj_parser("./test_assets/face_normal.obj");
...
{
	const struct CMUnitTest	obj_parser_face_normal_tests[] = {
		cmocka_unit_test(face_normal_obj_parser_1_test),
	};
	return (cmocka_run_group_tests(obj_parser_face_normal_tests, NULL, NULL));
}
