...
/*   Updated: 2025/11/26 16:56:11 by lcesbron         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
{
	t_shape	s = sphere(0);
	t_precomp	comps = precompute((t_inter){.s = &s, .point = 4}, (t_ray){point(0, 0, -5), vector(0, 0, 1)}, NULL);
...
{
	t_shape	s = sphere(0);
	t_precomp	comps = precompute((t_inter){.s = &s, .point = 1}, (t_ray){point(0, 0, 0), vector(0, 0, 1)}, NULL);
